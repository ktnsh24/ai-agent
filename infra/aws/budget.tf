...
resource "aws_lambda_function" "budget_killer" {
  function_name    = "${local.name_prefix}-budget-killer"
...
resource "aws_iam_role" "budget_killer_role" {
  name               = "${local.name_prefix}-budget-killer-role"
...
resource "aws_iam_role_policy" "budget_killer_policy" {
  name = "${local.name_prefix}-budget-killer-policy"
    ...
    Statement = [
      ...
      },
      {
        ...
        Action = [
          ...
          "dynamodb:ListTables", "dynamodb:DeleteTable",
