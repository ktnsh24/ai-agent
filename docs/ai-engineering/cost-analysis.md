...
- [Cost Analysis — AI Agent](#cost-analysis--ai-agent)
  - [Table of Contents](#table-of-contents)
  - [Monthly Cost Summary](#monthly-cost-summary)
    - [Development (personal account)](#development-personal-account)
    - [Production (small scale: ~500 queries/day)](#production-small-scale-500-queriesday)
  - [Why Agents Cost More Than Chat](#why-agents-cost-more-than-chat)
    - [Token Multiplier Effect](#token-multiplier-effect)
  ...
  - [What Alternatives Cost More](#what-alternatives-cost-more)
    - [Alternative 1: OpenAI Assistants API instead of LangGraph](#alternative-1-openai-assistants-api-instead-of-langgraph)
    - [Alternative 2: AWS Bedrock Agents instead of custom](#alternative-2-aws-bedrock-agents-instead-of-custom)
    - [Alternative 3: CrewAI for single-agent instead of LangGraph](#alternative-3-crewai-for-single-agent-instead-of-langgraph)
